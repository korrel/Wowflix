<!-- ///////////////////////////  AJOUTER UNe bande annonce /////////////////////////// -->
        ...
        <section class="container-fluid ajout-film-section position-relative px-0">
            <div class="filter02"></div>
            <div class="container text-center text-white section-ajout">
                ...
                <a class="btn btn-redy"><i class="fas fa-play-circle"></i> Ajouter une vidéo</a>
            </div>
        </section>
        ...
        <div class="container">
            <div class="row flex-direction-row">
                <div class="col-12 col-md">
                    <p class="text-center text-muted">Wowflix 2018 &#9400; Sébastien Renoult</p>
                </div>
            </div>
        </div>
      </footer>
